...
//------------------------------------------------------------------------------
    ...
    Lobibox.base.DEFAULTS = {
        ...
        iconSource: 'materialize',            // "bootstrap" or "fontAwesome" the library which will be used for icons
...
//------------------------------------------------------------------------------
        ...
        var _createNotify = function () {
            ...
            if (me.$options.img) {
                ...
                $innerIconEl.append('<div class="icon-el"><i class="material-icons">' + me.$options.icon + '</i></div>');
            } else {
...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify.DEFAULTS = {
        ...
        soundPath: $base_url + 'static/sounds/',   // The folder path where sounds are located
