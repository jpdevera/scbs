...
<p class="folderInfo">
    <?php echo $imagebrowser2; ?> 
    <span id="finalcount"></span> 
    <?php echo $imagebrowser3; ?> - 
...
<div id="imageFullSreen" class="lightbox popout">
    <div class="buttonBar">
        <button id="imageFullSreenClose" class="headerBtn" onclick="$('#imageFullSreen').hide(); $('#background').slideUp(250, 'swing');">
            <img src="img/cd-icon-close.png" class="headerIcon">
        </button>
        <a href="#" id="imgActionDownload" download>
            <button class="headerBtn">
                <img src="img/cd-icon-download.png" class="headerIcon">
            </button>
        </a>
        <button class="headerBtn greenBtn" id="imgActionUse" onclick="#" class="imgActionP">
            <img src="img/cd-icon-use.png" class="headerIcon"> <?php echo $buttons3; ?>
        </button>
    </div>
...
<div id="uploadImgDiv" class="lightbox popout">
    <div class="buttonBar">
        ...
        <button class="headerBtn greenBtn" name="submit" onclick="$('#uploadImgForm').submit();">
            <img src="img/cd-icon-upload.png" class="headerIcon"> 
            <?php echo $buttons7; ?>
        </button>
    ...
    <form action="<?php echo $base_url ?>upload/upload_ckeditor/" method="post" enctype="multipart/form-data" id="uploadImgForm" onsubmit="return checkUpload();">
        <input type="hidden" name="ck_token" value="1" />
        <p class="uploadP">
            <img src="img/cd-icon-select.png" class="headerIcon"> <?php echo $uploadpanel1; ?>
        </p>
        <input type="file" name="upload" id="upload">

        <br>

        <!-- <h3 class="settingsh3" style="font-size:12px;font-weight:lighter;"><?php echo $uploadpanel2; ?> -->

        <br>

        <!-- <span style="font-weight:bolder;">"<?php echo $useruploadfolder; ?>"</span> 
        (<?php echo $uploadpanel3; ?>) -->
        </h3>

        <div id="src_div">
            <img id="src_img" height="300" width="300">
        </div>
...
?>
    <div id="settingsDiv" class="lightbox popout">
        ...
        ?>
        <!--cancel btn-->
        <button class="headerBtn greyBtn saveUploadPathA" id="pathCancel">
            <?php echo $buttons5; ?>
        </button>
        <!--save btn-->
        <button class="headerBtn saveUploadPathA" onclick="updateImagePath();">
            <?php echo $buttons6; ?>
        </button>

        <br class="saveUploadPathA">

        <br>

        <h3 class="settingsh3">
            <?php echo $panelsettings4; ?>
        </h3>
        ...
        <?php 
            ...
            { 
        ?>
            <p class="uploadP" onclick="disableNews()">
                <img src="http://www.maleck.org/imageuploader/img/hide.png" class="headerIcon"> 
                <?php echo $panelsettings21; ?>
            </p>

        <?php 
            } 
            elseif($news_sction == "no") 
            { 
        ?>
            <p class="uploadP" onclick="enableNews()">
                <img src="http://www.maleck.org/imageuploader/img/show.png" class="headerIcon"> 
                <?php echo $panelsettings22; ?>
            </p>
        <?php 
            } 
        ?>
        ...
        ?>
            <p class="uploadP" onclick="extensionSettings('no');">
                <img src="img/cd-icon-hideext.png" class="headerIcon"> 
                <?php echo $panelsettings5; ?>
            </p>

        <?php 
            } 
            elseif($file_extens == "no") 
            { 
        ?>
            <p class="uploadP" onclick="extensionSettings('yes');">
                <img src="img/cd-icon-showext.png" class="headerIcon"> 
                <?php echo $panelsettings6; ?>
            </p>
        <?php } ?>
        <!--change language-->

        <p class="uploadP" onclick="openLangPanel();">
            <img src="img/cd-icon-translate.png" class="headerIcon"> 
            <?php echo $panelsettings20; ?>
        </p>

        <!--show if password is enabled-->
        <?php 
            if( $_SESSION["username"] != "disabled_pw")
            { 
        ?>
            <br>

            <h3 class="settingsh3">
                <?php echo $panelsettings7; ?>
            </h3>

            <!--logout-->
            <p class="uploadP" onclick="logOut();">
                <img src="img/cd-icon-logout.png" class="headerIcon"> 
                <?php echo $panelsettings8; ?>
            </p>
            <!--disable password-->
            <p class="uploadP" onclick="window.open('http://imageuploaderforckeditor.altervista.org/disable_pw.html','about:blank', 'toolbar=no, scrollbars=yes, resizable=no, width=900, height=600');">
                <img src="img/cd-icon-disable.png" class="headerIcon"> 
                <?php echo $panelsettings9; ?>
            </p>
        <?php 
            } 
        ?>
        ...
        <h3 class="settingsh3">
            <?php echo $panelsettings10; ?>
        </h3>
        <!--donate button-->
        <p class="uploadP" onclick="$( '#donate' ).submit();">
            <img src="img/cd-icon-coffee.png" class="headerIcon"> 
            <?php echo $panelsettings11; ?>
        </p>

        <br>

        <h3 class="settingsh3">
            <?php echo $panelsettings12; ?>
        </h3>
        <!--FAQ button-->
        <p class="uploadP" onclick="window.open('http://imageuploaderforckeditor.altervista.org/support/','_blank');">
            <img src="img/cd-icon-faq.png" class="headerIcon"> 
            <?php echo $panelsettings13; ?>
        </p>

        <!--report a bug-->
        <p class="uploadP" onclick="window.open('http://ibm.bplaced.com/contact/index.php?cdproject=Image%20Uploader%20and%20Browser%20for%20CKEditor&cdlink=<?php echo $link; ?>&cdver='+currentpluginver,'_blank');">
            <img src="img/cd-icon-bug.png" class="headerIcon"> 
            <?php echo $panelsettings14; ?>
        </p>

        <br>
        <h3 class="settingsh3">
            <?php echo $panelsettings15; ?>
        </h3>
        <!--current version-->
        <p class="uploadP">
            <img src="img/cd-icon-version.png" class="headerIcon"> 
            <?php echo $currentpluginver; ?>
        </p>

        <br>
        <h3 class="settingsh3">
            <?php echo $panelsettings16; ?>
        </h3>
        <!--credits-->
        <p class="uploadP">
            <img src="img/cd-icon-credits.png" class="headerIcon"> 
            <?php echo $panelsettings17; ?>
        </p>

        <br>
        <h3 class="settingsh3">
            <?php echo $panelsettings18; ?>
        </h3>
        <!--icon refr-->
        <p class="uploadP" onclick="window.open('https://icons8.com','_blank');">
            <img src="img/cd-icon-images.png" class="headerIcon"> 
            <?php echo $panelsettings19; ?>
        </p>
