...
$root_folder            = dirname( dirname( dirname( dirname( ( dirname( __DIR__ ) ) ) ) ) );
$rootbasename           = basename( $root_folder );

if( !defined('BASEPATH') )
{
    define('BASEPATH', $root_folder);
}

require_once($root_folder.DIRECTORY_SEPARATOR.$application_folder.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'constants.php');
require_once($root_folder.DIRECTORY_SEPARATOR.$application_folder.DIRECTORY_SEPARATOR.'helpers'.DIRECTORY_SEPARATOR.'common_helper.php');
...
$base_url_upload_path   = $usersiteroot."$useruploadfolder/";

// $username = "administrator"; $password = '25d55ad283aa400af464c76d713c07ad';
$username               = CKEDITOR_ADMIN; $password = CKEDITOR_ADMIN_PASS;

$file_path              = $root_folder.DIRECTORY_SEPARATOR.PATH_CKEDITOR_UPLOADS;
$file_path              = str_replace(array('/', '\\'), array( DS, DS ), $file_path);

$useruploadfolder       = $file_path;
    // $useruploadpath = $usersiteroot."$useruploadfolder/";
$useruploadpath         = "$useruploadfolder/";
$foldershistory[]       = $file_path;
$base_url_upload_path   = PATH_CKEDITOR_UPLOADS;     
