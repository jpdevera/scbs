...
$.fn.lazySelectize = function (settings) {
    ...
    self.extraData = settings.data || {};
    self.scrollFunc = settings.scrollFunc || function(){};
    self.successFunc = settings.successFunc || function(){};
    ...
    settings.load = function(query, callback) {
        self.scrollFunc(self, self.selectize);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                self.successFunc(self, self.selectize);
            }
        });
    };
