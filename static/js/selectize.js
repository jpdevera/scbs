...
(function(root, factory) {
	...
	$.extend(Selectize.prototype, {
		...
		positionDropdown: function() {
			...
			if (!inViewPort) 
			{ 
				if( self.settings.dropdownParent == 'body' )
				{
					return self.setDropdownDirection('down'); 
				}
				else
				{
					return self.setDropdownDirection('up'); 
				}	
			}
		},
		...
		setDropdownDirection: function (direction) {
			...
			this.$dropdown.css(css_opt).toggleClass('dropdown-up', (direction === 'down') ? false : true);


			if( this.settings.dropdownParent === 'body' )
			{
				this.$dropdown.css('zIndex', '9999');
			}
		},
