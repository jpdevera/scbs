...
<div class="table-display m-b-lg">
	...
	<div class="table-cell valign-top p-md" style="width:65%;">
		<div class="scroll-pane field-multi-attachment" style="height:380px">
			<input type="hidden" data-parsley-errors-container=".my_error_container" data-parsley-error-message="This field is required." data-parsley-required="true" name="files[]" id="images" value="" class="form_dynamic_upload"
				data-origfile=""
			>
			<input type="hidden" name="files_orig_filename[]" id="images_orig_filename" value="" class="form_dynamic_upload_origfilename">
			<a href="#" id="images_upload" class="tooltipped m-r-sm" data-position="bottom" data-delay="50" data-tooltip="Upload">Choose a file to upload</a>
