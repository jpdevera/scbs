	...
	<div class='row m-b-n p-t-xs list-details'>
		...
		<div class='col l6 m11 s12 right-align center-oso left-omo'>
			<ul class='list-action-buttons circles p-n' >
				...
				?>
					<li ><a data-target="modal_audio_player" class="modal_audio_player_triger btn-floating btn-medium waves-effect waves-light tooltipped" data-tooltip='View Audio'  onclick="modal_audio_player_init('', this, 'Audio Player')" data-modal_post='<?php echo $pass_args_json ?>'><i class="material-icons">open_in_new</i></a>
					<?php
						// else :
					?>
