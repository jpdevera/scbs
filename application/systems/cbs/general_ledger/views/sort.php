<div class="page-title">
	<div class="table-display">
		<div class="table-cell valign-middle s6"><h5>GL SortCode</h5></div>
		<div class="table-cell valign-middle right-align s6">
			<div class="inline p-l-xs">
				<button data-target="modal_add" class="btn waves-effect waves-light green lighten-2 modal_add_trigger" name="add_sortcode" onclick="modal_add_init('<?php echo $security ?>',this, 'Add GL Sortcode')" type="button"><i class="material-icons">library_add</i>Add GL Sortcode</button>
			</div>
		</div>
	</div>
</div>
...
<div class="m-md">
	<div>
		<table cellpadding="0" cellspacing="0" class="table table-default table-layout-auto" id="tbl_data_list">
			<thead>
				<tr>
					<th width="25%">Sort Code</th>
					<th width="30%">Sort Name</th>
					<th width="30%">GL Type</th>
					<th width="15%" class="center-align"></th>
				</tr>
				<tr class="table-filters">
					<td width="25%"><input name="sort_code" class="form-filter"></td>
