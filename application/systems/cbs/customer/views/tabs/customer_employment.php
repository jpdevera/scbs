...
<div class="table-display">
      <div class="table-cell s3 valign-top">
        <div class="input-field label-right right-align m-r-sm">
          <label class="m-r-xs p-r-xxs required">Company Name</label>
        </div>
      </div>
    ...
    <div class="table-display">
      <div class="table-cell s3 valign-top">
        <div class="input-field label-right right-align m-r-sm">
          <label class="m-r-xs p-r-xxs required">TIN</label>
        </div>
      </div>
      ...
      <div class="table-cell s3 valign-top">
        <div class="input-field label-right right-align m-r-sm">
          <label class="m-r-xs p-r-xxs required">Date Hired</label>
        </div>
      </div>
      ...
      <div class="table-cell s3 valign-top">
        <div class="input-field label-right right-align m-r-sm">
          <label class="m-r-xs p-r-xxs required">Occupation</label>
        </div>
      </div>
      ...
      <div class="table-cell s3 valign-top">
        <div class="input-field label-right right-align m-r-sm">
          <label class="m-r-xs p-r-xxs required">Phone Number</label>
        </div>
      </div>
